...
| [G5-OC2](G5-OC2-2026-08-05.md) | 2026-08-05 | Device-tested once: 750 MHz GPU OPP @ 964 mV (on-grid) — **PASS**: 750 parses, clock chain runs cur=750000000 held during render, rail delivers exactly 964000 uV (summary-confirmed), zero real GPU faults. +5.6% over stock 710. | 750 device-proven (local-only). Options: sweep 800/850 in one build to find the rail-limited ceiling (~900), or keep 750 and move on (browser/WiFi). Short-session proof only — soak test if kept. |
