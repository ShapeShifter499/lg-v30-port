...
| [A189](A189-2026-08-04.md) | 2026-08-04 | Device-tested once (clean retest of TE re-arm): boot + mechanical blank→lock→wake passed; TE re-arm after display-on did NOT remove the wake rainbow garbage — hypothesis REJECTED. No driver errors; authorization consumed. | Next (A190): wake-side ELVSS/compensation block (E8/CE/E7 + delays) that downstream sends in its ON-command and our driver omits. |
