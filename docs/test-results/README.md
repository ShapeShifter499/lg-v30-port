...
| [GPU-FULL3](GPU-FULL3-2026-08-04.md) | 2026-08-04 | Device-tested once: GPU fully operational — all 7 clock levels (257→710 MHz) switch with 260 real transitions, OPP voltage scaling delivers the measured corners (936 mV @ 710, 792 mV @ 515), interconnect qnoc clean with active gfx-mem vote, both GPU thermal zones live, GL_RENDERER=FD540 ES 3.1 renders. PASS. | G4 sequenced: GX power-collapse restore — drop runtime-PM hold (231efbcc6) as one variable with fresh approval. Kernel branch local-only until trailer canonicalization. |
