...
| [A186](A186-2026-08-04.md) | 2026-08-04 | Device-tested once: boot + mechanical blank→lock→wake passed; post-display-on settle 20→120 ms did NOT remove the wake rainbow garbage — hypothesis REJECTED. No driver errors; authorization consumed. | A187 (continuous DSI clock lane, matching downstream force-clock-lane-hs) is the next one-variable candidate. |
