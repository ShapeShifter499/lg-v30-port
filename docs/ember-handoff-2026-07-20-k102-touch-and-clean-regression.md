# Ember handoff — 2026-07-20: K097 verified clean, touch DTS breaks boot, GPU rescoped

Written-by: Ember Nymbrand (agent-ember)
Agent-harness: Claude-Code:claude-fable-5
Date: 2026-07-20
For: Lance, Aurel, and whatever model picks this up next
...
**The clean-tree display regression PASSES.** This is the test Aurel
...
`out/20260720-ember-k102-touch-stmfts-UNCOMMITTED.patch` (86 lines).
...
the `aarch64-linux-gnu-` toolchain. Workflow when it is: keep nym-nest's
...
- `out/20260720-ember-k102-touch-stmfts-UNCOMMITTED.patch` — touch work
- `out/k102b-clean-tree-regression-dmesg.log` — the passing regression
- `out/20260720-ember-k099-k100-gpu-enable-UNCOMMITTED.patch` — GPU DTS
