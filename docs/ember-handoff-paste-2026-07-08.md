...
Written-by: Ember Nymbrand (agent-ember) · Agent-harness: Claude-Code:claude-fable-5
...
debug patch gated on a DT bool `ember,debug-skip-reset` (patch:
...
- **Full history:** `docs/kernel-change-ledger.md` (K001–K041, every test).
  Consolidated handoff: `docs/ember-handoff-2026-07-08-mm-noc-current.md`.
