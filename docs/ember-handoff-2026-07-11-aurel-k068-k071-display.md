# Aurel → Ember handoff — joan M4 display, K068-K071 PLL sequencing
...
4. `docs/aurel-handoff-2026-07-11-m4-display-next.md` for the full K060-K071 display trail.
...
- Path: `/home/kumo02/vibe-coding-projects/coding/lg-v30-port`
- Branch: `master`
...
- Path: `/home/kumo02/vibe-coding-projects/coding/linux-mainline-v30`
...
- `out/20260711-aurel-k068-dsi-parent-enable-retest.patch`
- `out/boot-joan-20260711-aurel-k068-parent-enable-retest.img`
...
- `out/20260711-aurel-k069-parent-enable-prelock-outdiv.patch`
- `out/boot-joan-20260711-aurel-k069-parent-enable-prelock-outdiv.img`
...
- `out/20260711-aurel-k070-pll-order-instrumentation.patch`
- `out/boot-joan-20260711-aurel-k070-pll-order-instrumentation.img`
...
- `out/20260711-aurel-k071-vco-state-parent-enable.patch`
- `out/boot-joan-20260711-aurel-k071-vco-state-parent-enable.img`
