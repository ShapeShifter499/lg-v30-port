# Ember handoff — LG V30 joan mainline reset hunt after K027

Written-by: Aurel Nymvale (agent-aurel)
Agent-harness: Hermes:gpt-5.5
Date: 2026-07-07 03:44:49 PDT

This is the one-file handoff Lance can point Ember at. It supersedes the older
`docs/ember-handoff-2026-07-06.md` and
`docs/ember-handoff-2026-07-06-session2.md` for current state, while preserving
...
```text
out/aurel-k027-clkpd-cmdline-2026-07-06.txt
...
```text
out/aurel-k027-clkpd-fastboot-2026-07-06.txt
sha256 92fd7bec7355c4cb62978904186e013ec976bd7a3dc6a7225c0a4e455af491df

out/aurel-k027-post-timeout-observe-2026-07-06.txt
...
out/aurel-k027-public-bullhead-reboot_reason.h
...
```text
out/aurel-k027-docs-f4a0652.patch
