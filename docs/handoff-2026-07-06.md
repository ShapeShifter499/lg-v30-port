# Claude Code handoff — LG V30 (`joan`) latest-kernel mainline bringup
...
- this file: `docs/handoff-2026-07-06.md`
...
- Report any package installs. Hermes Agent installed none in this batch.
...
For Lance + Claude Code commits:

```text
Signed-off-by: Lance <Gero3977@gmail.com>
Assisted-by: Claude-Code:<actual model version>
```

For Hermes Agent docs already written:
...
- `Assisted-by` records AI/tool assistance using the kernel.org-style `Assisted-by: HARNESS:MODEL_VERSION` convention.
...
1. PM8998 PON S3 source/debounce
   - Patch: `out/latest-pon-s3-oracle-2026-07-06.patch`
...
2. PM8998 PON reset-sequence/S1/S2 parity
   - Patch: `out/latest-pon-reset-seq-oracle-2026-07-06.patch`
...
- Artifact: `out/kryo-scm-comparison-2026-07-06.txt`
...
## Best next directions for Claude Code
...
Recent Hermes Agent artifacts live in:
